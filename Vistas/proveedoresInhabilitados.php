      ...
      <main class="app-content">
       <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <img class="rounded-circle user-image" width="40" height="40" src="../images/ayuda.png"  href="#" onclick="window.open('../Files/proveedoresinhabiliados.pdf', '_blank', 'fullscreen=yes'); return false;">
</div>
 </div>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="row">
              ...
              <label for="nombreU" style="font-size:16px;">¿Desea Inhabilitar a :  </label>
