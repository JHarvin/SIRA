                 ...
                 <form method="post" onsubmit="return validarActualizarDatos();">
                  <div class="row mb-4">
                    <div class="col-md-3">
                      ...
                      <input id="Nombre" name="Nombreu" class="form-control" type="text" value="<?php echo $datosVista["nombre"]; ?>"

                        maxlength="100" pattern=".{7,}" title="7 o mas caracteres para nombre real" required >
                    </div>
                    <div class="col-md-3">
                      <label for="Telefono">Teléfono</label>
                      <input id="Telefono" name="Telefonou" class="form-control" type="text" value="<?php echo $datosVista["telefono"]; ?>" required>
                    </div>
        <div class="form-group col-md-3">
       <span class="label label-success">DUI:</span>
     <input type="text" name="duiu" id="dui" class="form-control mask-dui" autocomplete="off" autofocus placeholder="Dui..."value="<?php echo $datosVista["dui"]; ?>" required>
     </div>
    <div class="form-group col-md-3">
    <span class="label label-success">N° Licenia de conducir</span>
    <input type="text" name="licenciau" id="licencia" class="form-control mask-licencia" autocomplete="off" autofocus placeholder="licencia..." value="<?php echo $datosVista["licencia_de_conducir"]; ?>" required>
     </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input id="Direccion" name="Direccionu" class="form-control" autocomplete="off" type="text" value="<?php echo $datosVista["direccion"]; ?>" required>
                    </div>
                    <div class="clearfix"></div>
              ...
              <label for="statusu">Estado</label>
                <select class="form-control" name="statusu">
                  <?php
