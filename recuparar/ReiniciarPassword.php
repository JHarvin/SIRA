      ...
      <div class="lock-box"><img class="rounded-circle user-image" src="../images/candado.png">
		...
		<div class="regisFrm">
			<form class="unlock-form" action="MiCuenta.php" method="post">
				<input type="password" name="password1" class="form-control" placeholder="Digite nueva contraseña" required="">
				<input type="password" name="password2" class="form-control" placeholder="Vuelva a escribir la nueva contraseña" required="">
