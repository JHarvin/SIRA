<?php
	...
	$query = "SELECT tproductos.tipo, tproductos.codigo, tproductos.precio_venta, tproveedores.nombre
	FROM tproductos INNER JOIN tproveedores ON tproductos.idproveedor = tproveedores.idproveedor";
